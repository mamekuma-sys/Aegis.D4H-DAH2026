...
SYSTEM_PROMPT = (
    ...
    "- L4 ugv-node TCP 8410/8420 — h2c gRPC g2dds.v1.Layer4Service, NOT HTTP. "
    "The deterministic G2DDS transport owns these ports.\n"
    "Never emit HTTP or GraphQL plans for native-only ports 9000, 1883, 8554, 8410, or 8420.\n"
