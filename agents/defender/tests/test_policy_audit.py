...
class TestLoadOrder(unittest.TestCase):
    ...
    def test_shipped_bundle_activates_only_reviewed_observed_rules(self):
        ...
        self.assertEqual(report.source, "active")
        self.assertEqual(report.bundle_id, "defender-2026-08-21-p3-mqtt-rtsp")
        self.assertEqual(report.drop_capable_rules, 24)
        ...
        active_ids = {
            ...
            "sig-l3-product-union-broad-001",
            "sig-l2-graphql-schema-001",
            "sig-l4-flag-secret-001",
            "http-l1-config-flag-canonical-001",
            "http-l1-config-flag-canonical-post-001",
            "sig-l3-mqtt-wildcard-flag-001",
            "sig-l3-rtsp-flag-path-001",
        }
    ...
    def test_shipped_active_rules_are_evidence_scoped_by_observed_layer(self):
        ...
        self.assertEqual(
            ...
            {8080: 7, 8082: 13, 9000: 2, 9090: 5, 8410: 1, 8420: 1, 1883: 1, 8554: 1},
        )
    ...
    def test_shipped_bundle_expires_after_finals_validity_window(self):
        ...
        self.assertEqual(len(report.demotions), 24)
