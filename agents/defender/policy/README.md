...
현재 bundle은 `defender-2026-08-21-p3-all-semantic`입니다. 본선 TCP profile `6/8080`, `6/9000`, `6/8082`, `6/1883`, `6/8554`, `6/9090`, `6/8410`, `6/8420`을 등록했습니다. 증거·정상 negative·SLA fixture와 두 review가 있는 rule 28개가 `ACTIVE`이고, 일반 휴리스틱 및 아직 PCAP 승격 근거가 없는 MQTT/RTSP 후보 15개는 `SHADOW`입니다. ACTIVE 규칙은 `2026-09-01T00:00:00Z`에 만료합니다.
