...
현재 bundle은 `defender-2026-08-21-p4-r11-cross-layer-hardening`입니다. 본선 TCP profile `6/8080`, `6/9000`, `6/8082`, `6/1883`, `6/8554`, `6/9090`, `6/8410`, `6/8420`을 등록했습니다. 증거·정상 negative·SLA fixture와 두 review가 있는 rule 40개가 `ACTIVE`이고, L4 reflection·`GetCatalog`와 일반 휴리스틱·스캔·flow-score rule 14개는 `SHADOW`입니다. ACTIVE 규칙은 `2026-09-01T00:00:00Z`에 만료합니다.

활성 범위는 L1 helper/config/SatDiag/`/svc/flag-*`와 portal `service_id`, L2 GraphQL/RSC/mission-feed/admin/loopback SSRF, L3 SQLi·MQTT/RTSP·9090 MQTT bridge·query 기반 imagery ingest, L4 Exchange/ROS/mission exact 조합, 보호 서비스 응답의 flag 유출입니다. query 없는 portal/imagery, GraphQL `systemConfig`, L4 reflection·`GetCatalog`는 차단하지 않습니다. HTTP/gRPC 의미 규칙은 bounded in-order prefix에만 적용하고 User-Agent나 NAT source IP만으로는 차단하지 않습니다.
