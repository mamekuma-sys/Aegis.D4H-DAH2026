...
```bash
bash scripts/validate-skeleton.sh <본인-스켈레톤-루트>
```
...
```bash
bash scripts/validate-skeleton.sh ../DAH2026_스켈레톤코드
```

Windows에서는 같은 검사를 기존 `.ps1` 스크립트로 실행할 수 있습니다.
