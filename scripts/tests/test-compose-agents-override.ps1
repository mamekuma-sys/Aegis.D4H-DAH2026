...
if ($defenderText -notmatch 'bundle_id=defender-2026-08-21-p4-r11-cross-layer-hardening') {
    throw 'defender-deploy.md does not require the P2-R3 hardened bundle id.'
}
if ($defenderText -notmatch 'drop_capable_rules=40') {
    throw 'defender-deploy.md does not require drop_capable_rules=40.'
}
